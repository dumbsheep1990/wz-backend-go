...
import (
	...
	"github.com/yourusername/wz-backend-go/internal/infrastructure/assembly"
...
func main() {
	...
	// Assemble the community service
	communityAssembly := assembly.NewCommunityServiceAssembly(db, txManager)
	...
	pb.RegisterCommunityServiceServer(grpcServer, communityAssembly.GRPCAdapter)
