...
func main() {
	...
	// Assemble the site service
	siteAssembly := assembly.NewSiteServiceAssembly(db, txManager)
	...
	pb.RegisterSiteServiceServer(grpcServer, siteAssembly.GRPCAdapter)
	
	// Handle graceful shutdown
	go func() {
		log.Printf("Starting site gRPC server on port %s", port)
	...
	log.Println("Shutting down site gRPC server...")
	grpcServer.GracefulStop()
	log.Println("Site server exited properly")
}
