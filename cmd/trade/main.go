...
func main() {
	...
	// Assemble the trade service
	tradeAssembly := assembly.NewTradeServiceAssembly(db, txManager)
	...
	pb.RegisterTradeServiceServer(grpcServer, tradeAssembly.GRPCAdapter)
	
	// Handle graceful shutdown
	go func() {
		log.Printf("Starting trade gRPC server on port %s", port)
	...
	log.Println("Shutting down trade gRPC server...")
	grpcServer.GracefulStop()
	log.Println("Trade server exited properly")
}
